...
import kotlinx.android.synthetic.main.activity_tap_range_selection.*
import android.widget.Toast.LENGTH_SHORT as toastShort

class TapRangeSelectionActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        setContentView(R.layout.activity_tap_range_selection)
